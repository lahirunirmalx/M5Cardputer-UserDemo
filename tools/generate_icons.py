...
# Apps currently on cardputerADV-dev that ship icons from this generator.
# The draw_* functions for the other dev-main apps (mp3, gemini, led, tvbgone,
# blepair, env, scales) are kept in place above — adding their entries back
# here is the only step needed when those apps get ported from dev-main.
ICONS = [
